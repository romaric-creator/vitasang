              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <div className="flex flex-wrap items-center gap-3 mt-5">
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-[#0A66C2] px-5 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-[#004182] active:scale-95"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-[#128C7E] active:scale-95"
                  >
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
