export default {
  ...
  home: {
    ...
    profileLabel: "BONJOUR",
    alertsLabel: "Alertes",
    launchAlert: "Lancer une Alerte",
    urgentNeed: "Don de sang urgent • Besoin maintenant",
    ...
    nearby: "À proximité",
    launchAlertSubtitle: "Don de sang urgent • Besoin maintenant",
    bagsRequired: "poches requises",
    noUrgentAlertsSubtitle: "Merci aux donneurs !",
    ...
    totalCompleted: "Total effectués",
    nextDispo: "PROCHAINE DISPO",
    availableNow: "Disponible maintenant",
    alertsSent: "ALERTES ENVOYÉES",
    thisWeek: "Cette semaine",
    upcomingRDV: "RDV À VENIR",
    programmed: "Programmé",
    myBloodGroup: "Mon groupe",
    addIt: "Ajouter",
  ...
  profile: {
    ...
    rating: "Note",
    menu: "Menu",
    // Nouveaux champs section Informations
    ...
    recentMember: "Membre récent",
    availableToDonate: "Disponible pour donner",
    actions: "Actions",
    donationHistory: "Historique des dons",
    appointments: "Mes rendez-vous",
    eligibilityTest: "Test d'éligibilité",
    helpAdvice: "Aide & Conseils",
  },
  messages: {
    title: "Messagerie",
  ...
  register: {
    ...
    createProfile: "Créez votre profil de donneur",
    bloodGroup: "Groupe Sanguin",
    vitalInfo: "Cette information est vitale",
    continue: "CONTINUER",
    bloodGroupQuestion: "Quel est votre groupe sanguin ?",
    unknownBloodGroup: "Je ne connais pas mon groupe sanguin",
  ...
  alertPublic: {
    ...
    loadError: "Impossible de charger cette alerte.",
    thankYou: "Merci pour votre engagement !",
    responseError: "Erreur lors de la réponse.",
    loading: "Chargement de l'alerte...",
    notFound: "Alerte introuvable",
    notFoundDesc: "Cette alerte n'existe pas ou le lien est expiré.",
    backHome: "Retour à l'accueil",
    resolved: "Alerte résolue",
    cancelled: "Alerte annulée",
    resolvedDesc: "Merci ! Le besoin en sang a été satisfait grâce à des donneurs comme vous.",
    cancelledDesc: "Cette alerte a été annulée par le demandeur.",
    seeActive: "Voir les alertes en cours",
    heroTitle: "Merci, Héros !",
    heroDesc: "Le demandeur a été notifié de votre arrivée. Rendez-vous sur place dès que possible.",
    seeMissions: "Voir mes missions",
    headerTitle: "APPEL AU DON",
    forPatient: "Pour :",
    need: "Besoin :",
    bags: "poche(s)",
    securityNote: "Votre don peut sauver 3 vies aujourd'hui.",
    chat: "Discuter",
    refuse: "Refuser",
    loginHint: "Vous devrez vous connecter pour confirmer votre don.",
  },
  alertResponse: {
    missionInProgress: "MISSION EN COURS",
    distanceFromYou: "À {{distance}} de vous",
    unknownPatient: "Patient inconnu",
    goingText: "J'Y VAIS",
    requesterContact: "COORDONNÉES DU DEMANDEUR",
    emergencyContact: "Contact Urgence",
    call: "APPELER",
    openGPS: "Ouvrir le GPS",
    location: "Lieu",
    notFound: "Alerte introuvable",
    notFoundDesc: "Cette alerte a peut-être été résolue ou supprimée.",
    notified: "Notifiés",
    accepted: "Acceptés",
    read: "Vus",
  },
  alertTracking: {
    confirmTitle: "Confirmation de don",
    confirmMessage: "Confirmez-vous avoir effectué ce don ? Votre geste héroïque sera enregistré.",
    confirmYes: "Oui, je confirme",
    congratsTitle: "Félicitations",
    congratsMessage: "Merci pour votre don ! Vous avez sauvé une vie.",
    realEngagements: "Engagements réels",
    waitingDonors: "En attente de donneurs...",
    inProgress: "EN COURS...",
    donationDone: "J'AI EFFECTUÉ LE DON",
  },
  alertes: {
    myActivities: "Mes Activités",
    alertsSent: "alertes envoyées",
    noAlertHere: "Aucune alerte ici",
  },
  createAlert: {
    headerTitle: "LANCER SOS",
    introText: "Incitez la communauté à donner pour votre cas urgent.",
    locating: "Calcul de votre position...",
    bloodGroupRequired: "GROUPE SANGUIN REQUIS",
