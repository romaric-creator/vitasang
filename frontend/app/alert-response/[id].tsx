            ...
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.mainCard}>
                    ...
                    <Text style={styles.urgencyText}>
                        {t(`alert.urgencyLevels.${alertData.statut?.toUpperCase()}`) || alertData.statut?.toUpperCase()}
                    </Text>
                    {distance && (
                ...
                {!hasAccepted ? (
                    <View style={styles.actionContainer}>
                        <Text style={styles.confirmTitle}>{t('alert.response.confirmTitle')}</Text>
                        <Text style={styles.confirmDesc}>{t('alert.response.confirmDesc')}</Text>
                        ...
                        <View style={styles.btnRow}>
                            ...
                            >
                                <Text style={styles.ignoreBtnText}>{t('alert.response.no')}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                            ...
                            >
                                {isResponding ? (
                                    ...
                                    <Text style={styles.acceptBtnText}>{t('alert.response.yes')}</Text>
                                )}
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <View style={styles.contactCard}>
                        <Text style={styles.sectionTitle}>{t('alert.response.contactInfo')}</Text>
...
const styles = StyleSheet.create({
    ...
    urgencyText: { fontSize: 18, fontWeight: "800", color: color.primary, marginBottom: 8 },
    ...
    sectionTitle: { fontSize: 16, fontWeight: "800", color: color.textMain, marginBottom: 16 },
    ...
    confirmTitle: { fontSize: 20, fontWeight: "800", color: color.textMain, marginBottom: 10 },
    confirmDesc: { fontSize: 14, color: color.textSecondary, textAlign: "center", marginBottom: 24, paddingHorizontal: 20 },
    ...
    ignoreBtnText: { color: color.textSecondary, fontWeight: "700", fontSize: 16 },
    ...
    initiateurName: { fontSize: 18, fontWeight: "700", color: color.textMain, marginBottom: 16 },
    callFullBtn: {
        flexDirection: "row",
