...
const SanguAlertes = () => (
  <Svg width={260} height={280} viewBox="0 0 260 280">
    ...
    {/* Pavillon */}
    <Path
      d="M240 24 Q258 28 260 48 Q258 68 240 72"
      fill="#EF9A9A"
      stroke="#F9A825"
      strokeWidth={2}
    />
...
export default function OnboardingCarousel() {
  ...
  // Ref pour la liste et pour l'animation de défilement
  ...
  // Gestion du passage à la slide suivante
  const handleNext = () => {
  ...
  // Mise à jour de l'index actif seulement à la fin du mouvement pour la performance
  ...
  return (
    <ThemedView style={styles.container}>
      {/* Bouton Passer - HitSlop agrandit la zone tactile sans changer le design */}
      <TouchableOpacity
      ...
      <Animated.FlatList
        ...
        // Lie le défilement à notre valeur animée pour les points de pagination
      ...
      <View style={styles.paginationContainer}>
        {slides.map((_, i) => {
          ...
          // Le point s'élargit quand il est actif
          ...
          // Le point devient plus opaque quand il est actif
...
const styles = StyleSheet.create({
  ...
  textContainer: {
    height: 160, // Hauteur fixe pour éviter que le bouton "Suivant" bouge
    alignItems: "center",
  },
  title: {
    fontSize: 28,
